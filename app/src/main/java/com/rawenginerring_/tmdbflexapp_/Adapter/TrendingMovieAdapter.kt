...
class TrendingMovieAdapter(private val children : List<MovieModel>): RecyclerView.Adapter<TrendingMovieAdapter.ViewHolder>() {
            ...
            Observable.zip(
                ...
                object : Function4<MovieResponse, MovieResponse, MovieResponse, MovieResponse, Quadruple<MovieInfo, Credits, Review, MovieList>> {
                    override fun invoke(
                        ...
                        Log.d("TAG", "similarMovies**"+similarMovies.toString())
                        Log.d("TAG", "reviews**"+reviews.toString())
                        Log.d("TAG", "credits**"+credits.toString())
                        Log.d("TAG", "movieInfoM**"+movieInfo.toString())
